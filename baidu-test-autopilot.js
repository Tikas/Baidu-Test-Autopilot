// ==UserScript==
// @name         baidu-test-autopilot
// @namespace    https://xTikas.com/
// @version      0.30
// @description  An enhanced script for testing Baidu's autonomous driving, accompanied by a refreshing style.
// @author       Tikas
...
(function () {
  ...
  function keyconifg(a, b, c, d) {
    ...
    if (d > 0) {
      $(".rect-angle input[type='radio']")[d].click();
    }
  }
  ...
  function hotkey(event) {
    ...
    switch (event.keyCode) {
      ...
      case 101:
        if ($(".rect-isoccluded input[type='radio']")[0].checked === true) {
          ...
          $(".rect-isoccluded input[type='radio']")[1].checked === true
        ) {
    ...
    if (document.getElementById("tipshowstyle") == undefined) {
      var csss =
        "<style id='tipshowstyle'>.general-popup-mask{background:none; !important;}.general-popup{top:50%;left:50%; !important;}.general-popup-close{font-size:24px; !important;}.general-popup-notice-content{font-size:24px; !important;}</style>";
      $("html").append($(csss));
    }
  }
  var oB =
    document.getElementsByTagName("body")[0].children[1].children[1].children[3]
      .children[1];
  ...
  css += [
    ...
    "body,element.style,.pro-main,.mark-rect-draw-type{color: #000;background: #" +
      iBackground +
      "; !important;}",
  ].join("\n");
  sp.innerHTML = css;
